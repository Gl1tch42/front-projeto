...
@NgModule({
  ...
  providers: [HttpClientModule, LocalstorageService, AuthService, LoginService, GerenciarNotaService, VisualizarAulasService, BoletimEscolarService, VizualizarAulasAlunoService],
